...
# # 
    ...
    for sensor_temp, sensor_humi, sensor, color in zip(sensors_temp, sensors_humi, sensors, colors):
        ...
        plt.plot(sensor_data_temp['_time'], sensor_data_temp['_value'], label=sensor + ' Temp', color=color)
        ...
        plt.plot(sensor_data_temp['_time'], dew_point, label=sensor + ' Dew Point', linestyle='--', color=color)
    ...
    plt.savefig('temperature_and_dew_point_plot_15_04_24_test6.pdf')
    plt.savefig('temperature_and_dew_point_plot_15_04_24_test6.png')
    plt.show()
...
csv_file_temp = './../15_04_24/test6/2024-04-18_09_49_influxdb_data.csv' 
csv_file_humi = './../15_04_24/test6/2024-04-18_09_50_influxdb_data.csv'
